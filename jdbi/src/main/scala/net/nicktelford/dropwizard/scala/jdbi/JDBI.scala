package net.nicktelford.dropwizard.scala.jdbi
...
import net.nicktelford.dropwizard.scala.jdbi.tweak.{OptionContainerFactory, OptionArgumentFactory, IterableContainerFactory}
