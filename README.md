...
```scala
libraryDependencies += "com.datasift.dropwizard.scala" %% "dropwizard-scala-core" % "0.9.3-1"
```
...
<properties>
    ...
    <dropwizard.version>0.9.3-1</dropwizard.version>
...
```scala
libraryDependencies += "com.datasift.dropwizard.scala" %% "dropwizard-scala-jdbi" % "0.9.3-1"
```
