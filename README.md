...
```scala
libraryDependencies += "com.datasift.dropwizard.scala" %% "dropwizard-scala-core" % "0.8.5-1"
```
...
<properties>
    ...
    <dropwizard.version>0.8.5-1</dropwizard.version>
...
```scala
libraryDependencies += "com.datasift.dropwizard.scala" %% "dropwizard-scala-jdbi" % "0.8.5-1"
```
