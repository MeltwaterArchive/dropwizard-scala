...
/** Provides query parameter extractors for each type of Scala collection.
  *
  * @see [[com.datasift.dropwizard.scala.jersey.inject.CollectionQueryParamInjectable]]
  * @see [[com.datasift.dropwizard.scala.jersey.inject.CollectionParameterExtractor]]
  * @see [[com.datasift.dropwizard.scala.jersey.inject.OptionParameterExtractor]]
  */
@Provider
