...
/** Provides query parameter extractors for each type of Scala collection.
  *
  * @see [[io.dropwizard.scala.jersey.inject.CollectionQueryParamInjectable]]
  * @see [[io.dropwizard.scala.jersey.inject.CollectionParameterExtractor]]
  * @see [[io.dropwizard.scala.jersey.inject.OptionParameterExtractor]]
  */
@Provider
